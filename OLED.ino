...
void loop() {
  ...
  oled.setCursor(44,56);
  oled.print("TRY HARD"); 
  oled.drawBitmap(48, 16, heart1, 32, 32, WHITE);  //draw heart1 bitmap.
  oled.display();
  delay(500);  
  oled.clearDisplay();
  
  oled.setCursor(14,56);
  oled.print("BEST WISH FOR YOU");   
  oled.drawBitmap(36, 2, heart2, 56, 56, WHITE);  //draw heart2 bitmap.
  oled.display();
  delay(500);  
  oled.clearDisplay();  
}
